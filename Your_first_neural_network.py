...
def grid_search(iterations=5000,
                ...
                hidden_nodes=2,
                output_nodes=1):
    print("Start train for params iterations:%d,learning_rate:%.2f,hidden_nodes:%d,output_nodes:%d"           %(iterations, learning_rate, hidden_nodes, output_nodes))
    ...
    plt.show()
    result = dict()
    result['params'] = {'iterations':iterations,'learning_rate':learning_rate,                         'hidden_nodes':hidden_nodes,'output_nodes':output_nodes}
...
param_list = [{'iterations': 2000, 'learning_rate': 0.7, 'hidden_nodes': 16},    {'iterations': 1500, 'learning_rate': 0.9, 'hidden_nodes': 14},    {'iterations': 1500, 'learning_rate': 0.9, 'hidden_nodes': 12},    {'iterations': 2000, 'learning_rate': 0.7, 'hidden_nodes': 20},    {'iterations': 3000, 'learning_rate': 0.5, 'hidden_nodes': 20},    {'iterations': 2000, 'learning_rate': 0.7, 'hidden_nodes': 14},    {'iterations': 5000, 'learning_rate': 0.3, 'hidden_nodes': 12},    {'iterations': 2000, 'learning_rate': 0.7, 'hidden_nodes': 10},    {'iterations': 1500, 'learning_rate': 0.7, 'hidden_nodes': 18},    {'iterations': 2000, 'learning_rate': 0.9, 'hidden_nodes': 16},    {'iterations': 1500, 'learning_rate': 0.7, 'hidden_nodes': 14},    {'iterations': 5000, 'learning_rate': 0.3, 'hidden_nodes': 14},    {'iterations': 3000, 'learning_rate': 0.5, 'hidden_nodes': 12},    {'iterations': 3000, 'learning_rate': 0.9, 'hidden_nodes': 20},    {'iterations': 1500, 'learning_rate': 0.7, 'hidden_nodes': 16}]
